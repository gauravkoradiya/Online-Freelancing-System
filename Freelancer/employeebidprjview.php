...
<div id="tooplate_main">
	...
	<table width="100%" border="2">				<?php
				...
				$res2=mysql_query("select * from bidtbl where bid_id=".$b);
				...
				?>
						...
						<tr><td>Your Budget</td><td align="center" width="10%">:</td>
						<td align="left"><?php echo $r3[3]; ?></td></tr>
						
						<tr><td>Days to Complete</td>
						<td align="center" width="10%">:</td>
						<td align="left"><?php echo $r3[4]; ?></td></tr>
						<?php 
				...
				<?php } } ?>
						<tr><td>Date of Biding</td><td align="center" width="10%">:</td><td align="left"><?php echo $r3[7]; ?></td></tr>
